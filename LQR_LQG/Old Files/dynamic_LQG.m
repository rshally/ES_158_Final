function dynamic_LQR_V2(x_func, y_func)
...
finalIndex = 100;
deltaT = 0.1;
[xRef, uRef, xhat] = calc_reference(x_func, y_func, currIndex, finalIndex, deltaT);
...
function clicker(src, eventdata)
    global zz_pt xRef uRef  xhat finalIndex deltaT currIndex
    ...
    [xRef, uRef, xhat] = calc_reference(x_func, y_func, currIndex, finalIndex, deltaT, xhat, xRef, uRef);
    
    % Create new x and y functions for references
