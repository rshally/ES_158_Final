...
finalIndex = 100;
deltaT = 0.1;
[xRef, uRef, xhat] = calc_reference_LQG(x_func, y_func, currIndex, finalIndex, deltaT);
...
function clicker(src, eventdata)
    ...
    [xRef, uRef, xhat] = calc_reference_LQG(x_func, y_func, currIndex, finalIndex, deltaT, xhat, xRef, uRef);
